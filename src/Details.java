...
public class Details extends JFrame{
	...
	public Details(Player player) {
        ...
        public void actionPerformed(ActionEvent e){
        	...
        	player.getPokeBag().get(0).ChangeName(newname);
            Details re = new Details(player);
            setVisible(false);
        	}
        });
