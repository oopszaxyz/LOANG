...
public class Details4 extends JFrame{
	private Player player;
	private ArrayList<Pokemon> Poke;
	public Details4(Player player) {
		this.player = player;
        ...
        public void actionPerformed(ActionEvent e){
        	...
        	player.getPokeBag().get(3).ChangeName(newname);
            Details4 re = new Details4(player);
            setVisible(false);
        	}
        });
