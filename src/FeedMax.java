...
public class FeedMax extends JFrame{
	private Player player;
	public FeedMax(Player player) {
		this.player = player;
		setSize(1360,800);
		setTitle("Status");
		setVisible(true);
        ...
        butt[0].addActionListener(new ActionListener(){
			...
			public void actionPerformed(ActionEvent e) {
				player.getPokeBag().get(0).AtkUp(2);
				player.getPokeBag().get(0).HpUp(3);
				player.getPokeBag().get(0).SpUp(2);
				setVisible(false);
        ...
        butt[1].addActionListener(new ActionListener(){
			@Override
			public void actionPerformed(ActionEvent e) {
				player.getPokeBag().get(1).AtkUp(2);
				player.getPokeBag().get(1).HpUp(3);
				player.getPokeBag().get(1).SpUp(2);
				setVisible(false);
        ...
        butt[2].addActionListener(new ActionListener(){
			@Override
			public void actionPerformed(ActionEvent e) {
				player.getPokeBag().get(2).AtkUp(2);
				player.getPokeBag().get(2).HpUp(3);
				player.getPokeBag().get(2).SpUp(2);
				setVisible(false);
        ...
        butt[3].addActionListener(new ActionListener(){
			@Override
			public void actionPerformed(ActionEvent e) {
				player.getPokeBag().get(3).AtkUp(2);
				player.getPokeBag().get(3).HpUp(3);
				player.getPokeBag().get(3).SpUp(2);
				setVisible(false);
