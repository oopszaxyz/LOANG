...
public class Details3 extends JFrame{
	private Player player;
	private ArrayList<Pokemon> Poke;
	public Details3(Player player) {
		this.player = player;
        ...
        public void actionPerformed(ActionEvent e){
        	...
        	player.getPokeBag().get(2).ChangeName(newname);
            Details3 re = new Details3(player);
            setVisible(false);
        	}
        });
