...
public class FeedSuper extends JFrame{
	private Player player;
	public FeedSuper(Player player) {
		this.player = player;
		setSize(1360,800);
		setTitle("Status");
		setVisible(true);
        ...
        butt[0].addActionListener(new ActionListener(){
			...
			public void actionPerformed(ActionEvent e) {
				...
				player.getPokeBag().get(0).HpUp(2);
				setVisible(false);
        ...
        butt[1].addActionListener(new ActionListener(){
			...
			public void actionPerformed(ActionEvent e) {
				...
				player.getPokeBag().get(1).HpUp(2);
				setVisible(false);
        ...
        butt[2].addActionListener(new ActionListener(){
			...
			public void actionPerformed(ActionEvent e) {
				...
				player.getPokeBag().get(2).HpUp(2);
				setVisible(false);
        ...
        butt[3].addActionListener(new ActionListener(){
			...
			public void actionPerformed(ActionEvent e) {
				...
				player.getPokeBag().get(3).HpUp(2);
				setVisible(false);
